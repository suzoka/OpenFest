    ...
    <header className={`${styles.header} ${scroll > 10 || url === '/' ? styles.onscroll : ''}`}>
      ...
      <nav>
        <ul className={styles.navList}>
          ...
          <li>
            <Link
              href="/conseils"
              className={`${styles.navLink} ${url.startsWith('/conseils') ? styles.active : ''}`}
            >
              Conseils
            </Link>
          </li>
          <li>
            <Link
              href="/info"
              className={`${styles.navLink} ${url.startsWith('/info') ? styles.active : ''}`}
            >
              Démarche
            </Link>
          </li>
          <li>
            <Link
              href="/festival"
              className={`${styles.navLink} ${url.startsWith('/festival') ? styles.active : ''}`}
            >
          ...
          <li>
            <Link
              href="/tests"
              className={`${styles.navLink} ${url.startsWith('/tests') ? styles.active : ''}`}
            >
              [dev] Styles Guides
            </Link>
          </li>
      ...
      <div className={styles.headerBtnWrapper}>
        {user ? (
          ...
          >
            {userMenuOpen ? (
              <div className={styles.userMenuName}>
                ...
                <img
                  src={user?.avatar || 'https://placehold.co/400/000000/FFF'}
                  alt=""
          ...
          <Button as="link" href="/connection" type="secondary" className={styles.headerBtn}>
            Se connecter
          </Button>
        )}
      </div>
